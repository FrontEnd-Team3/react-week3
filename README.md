...
2. 코드 리팩토링
  <br/>
📍 아쉬웠던 점 <br/>
- api 관련 코드를 thunk를 사용하여 분리하는 데 시간을 많이 쓴 것 같아 아쉽다. 우선 기능 구현을 위주로 진행하다보니 코드에 가독성이 떨어지는 부분들도 있고 스타일도 손봐야 할 부분들이 있어서 오늘 기능 구현이 끝나면 그런 부분들을 다듬어볼 예정이다.

📍 내일 할 일<br/>: 프로젝트 기능 구현 마무리, 코드 리팩토링

### 0617

📍 오늘 한 일<br/>

1. 코드 리팩토링 (불필요한 usecontext 파일 정리 등)
2. 게시글 내용 더보기 구현
3. 미디어쿼리 적용 시도
4. 게시글 본문 react.markdown 등 사용하여 수정
  <br/>
📍 아쉬웠던 점 <br/>
- 게시글 내용을 그대로 보여주기만 했는데 깃허브 마크다운 문법으로 변환하는데 시간이 오래 걸렸다. 아직 미디어 쿼리를 제대로 적용하지 못해서 내일 제대로 마무리 해봐야겠다.
